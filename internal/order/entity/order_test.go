...
import (
	...
	"github.com/pinhobrunodev/pfa-go/internal/order/entity"
...
func TestGivenAnValidParams_WhenCallCalculateFinalPrice_ThenShouldCalculateFinalPriceAndSetItOnFinalPriceProperty(t *testing.T) {
	order, err := entity.NewOrder("123", 10, 2)
	assert.NoError(t, err)
